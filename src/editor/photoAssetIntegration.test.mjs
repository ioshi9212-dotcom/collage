...
assert.match(cloudSource, /typeof bridge\.getCloudProject === 'function'/);
assert.match(cloudSource, /await bridge\.getCloudProject\(\)/);
assert.doesNotMatch(cloudSource, /typeof bridge\.getPortableProject === 'function'/);
