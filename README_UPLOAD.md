...
В этой версии сервер больше не падает, если `SESSION_SECRET` не задан.
Но переменную всё равно лучше добавить в Railway Variables, иначе после каждого рестарта пользователи будут разлогиниваться.
